...
modeChange.addEventListener('click', (e) => {
    ...
    if (modeChange.children[1].innerHTML == 'Dark Mode') {
        ...
        modeChange.firstElementChild.src = 'assets/icons/light_mode.png';

        //saving values in localStorage
        localStorage.setItem('mode', 'dark');
        localStorage.setItem('--bg', '#32CD32');
        ...
        localStorage.setItem('--website_name_text_shadow', `0 0 5px #5D3FD3,
        0 0 10px #5D3FD3,
        0 0 20px #5D3FD3,
        0 0 40px #5D3FD3`);
        ...
        modeChange.src = 'assets/icons/dark_mode.png';
